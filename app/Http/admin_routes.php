...
Route::get('/', function () {
    return Redirect::to('/admin', 302); //view('welcome');
});
...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	/* ================== Advocates ================== */
	Route::resource(config('laraadmin.adminRoute') . '/advocates', 'LA\AdvocatesController');
	Route::get(config('laraadmin.adminRoute') . '/advocate_dt_ajax', 'LA\AdvocatesController@dtajax');
	...
	/* ================== Blog_Posts ================== */
	Route::resource(config('laraadmin.adminRoute') . '/blog_posts', 'LA\Blog_PostsController');
	Route::get(config('laraadmin.adminRoute') . '/blog_post_dt_ajax', 'LA\Blog_PostsController@dtajax');
